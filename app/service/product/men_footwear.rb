class Product::MenFootwear < Product::Base
  def initialize
    @base_catg_url = 'https://www.flipkart.com/mens-footwear/pr?sid=osp,cil&otracker=nmenu_sub_Men_0_Footwear'
  end
  ...
  def pagination_url(page_no)
    ...
    "https://www.flipkart.com/mens-footwear/pr?sid=osp%2Ccil&otracker=nmenu_sub_Men_0_Footwear&page=#{page_no}"
  end
